...
- [~] **Etapa 23 — Documentos & Vitrine** — motor único: **visual Premium no app + envio formatado elegante pro WhatsApp**. 📐 Orçamento · 🧾 Recibo/Notinha · 📖 Catálogo/Cardápio (produtos **ou** serviços), com a marca da empresa no cabeçalho
  ...
  - [ ] **23C — Recibo/Notinha** (aba placeholder pronta)
...
*Atualizado a cada etapa. Última: Etapa 23B (Documentos: Orçamento — modelos, itens livres com total, WhatsApp+PDF) ✅ — 2026-06-03 (executor-20260603-002; motor generalizado sem quebrar o catálogo; smoke visual Playwright 34/34). Próxima: Etapa 23C (Recibo/Notinha).*
