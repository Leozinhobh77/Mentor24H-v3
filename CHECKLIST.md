...
- [~] **Etapa 23 — Documentos & Vitrine** — motor único: **visual Premium no app + envio formatado elegante pro WhatsApp**. 📐 Orçamento · 🧾 Recibo/Notinha · 📖 Catálogo/Cardápio (produtos **ou** serviços), com a marca da empresa no cabeçalho
  ...
  - [ ] **23B — Orçamento** (aba placeholder pronta) · **23C — Recibo/Notinha** (aba placeholder pronta)
...
*Atualizado a cada etapa. Última: Etapa 23A (Documentos: Catálogo/Cardápio + Modelos) ✅ — 2026-06-02 (hub Documentos no Negócio, modelos salvos CRUD, preview premium com a marca + envio WhatsApp formatado; smoke visual Playwright 28/28). Próxima: Etapa 23B (Orçamento) / 23C (Recibo).*
