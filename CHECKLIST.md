...
*Atualizado a cada etapa. Última: Etapa 23C (Documentos: Recibo — valor por extenso + assinatura no PDF) ✅ — 2026-06-03 (executor-20260603-003; smoke visual Playwright 30/30). 🎉 Etapa 23 (Documentos & Vitrine) COMPLETA — trio Catálogo+Orçamento+Recibo. Próxima: Etapa 24 (Encomendas/Pedidos).*
